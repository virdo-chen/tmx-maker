        ...
        if kind_selection == 0:
            if k0_kind_part == 1:
                main_data_processor.moving_bricks_data.append(
                    [0, int(self.k0_bmEty.get()), int(self.k0_tmEty.get()), int(self.k0_speed_get.get()),
                     int(self.k0_x_get.get()), int(self.k0_y_get.get()), img_selection]
                )
            elif k0_kind_part == 2:
                main_data_processor.moving_bricks_data.append(
                    [1, int(self.k0_lmEty.get()), int(self.k0_rmEty.get()), int(self.k0_speed_get.get()),
                     int(self.k0_x_get.get()), int(self.k0_y_get.get()), img_selection]
                )
